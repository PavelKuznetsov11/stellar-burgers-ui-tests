...
class TestLogin:
    ...
    def test_login_homepage_login_button(self, driver_home, email, password):
        ...
        driver_home.find_element(*locs.EMAIL_LOGIN_BUTTON).send_keys(email)
        driver_home.find_element(*locs.PASSWORD_LOGIN_BUTTON).send_keys(password)
    ...
    def test_login_homepage_profile_button(self, driver_home, email, password):
    ...
    def test_login_button_from_register_page(self, driver_register, email, password):
        ...
        driver_register.find_element(*locs.EMAIL_LOGIN_BUTTON).send_keys(email)
        driver_register.find_element(*locs.PASSWORD_LOGIN_BUTTON).send_keys(password)
    ...
    def test_login_button_from_forgot_password_page(self, driver_forgot_password, email, password):
        ...
        driver_forgot_password.find_element(*locs.EMAIL_LOGIN_BUTTON).send_keys(email)
        driver_forgot_password.find_element(*locs.PASSWORD_LOGIN_BUTTON).send_keys(password)
