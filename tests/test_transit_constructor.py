...
class TestTransitConstructor:
    ...
    def test_constructor_button_transit_from_profile_account(self, driver_login, email, password):
    ...
    def test_stellar_burgers_logo_transit_from_profile_account(self, driver_login, email, password):
